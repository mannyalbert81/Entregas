...
<html lang="es">
	...
	function load_balance_comprobacion(pagina){
		...
		$.ajax({
			url:"<?php echo $helper->url("BalanceComprobacionAdmin","BalanceComprobacionAdmin");?>",
            type : "POST",
            async: true,			
			data: con_datos,
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("BalanceComprobacionAdmin","BalanceComprobacionAdmin"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12" target="_blank">
