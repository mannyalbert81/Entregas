...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Imprimir Consultar Plan Cuentas Admin - contabilidad 2016</title>
	...
	function load_plan_cuentas(pagina){
		...
		$.ajax({
			url:"<?php echo $helper->url("PlanCuentasAdmin","ImprimirConsultarPlanCuentasAdmin");?>",
            type : "POST",
            async: true,			
			data: con_datos,
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("PlanCuentasAdmin","ImprimirConsultarPlanCuentasAdmin"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12" target="_blank">
