...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Tipo de Cierre - 2016</title>
       ...
       <style>
		...
		$(document).ready(function(){
		    ...
		    $("#Guardar").click(function() 
			{
				...
				$( "#nombre_tipo_cierre" ).focus(function() {
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("TipoCierre","InsertaTipoCierre"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-6">
            
         
        	    <h4 style="color:#ec971f;">Insertar Tipos de Cierre</h4>
            	<hr/>
        ...
        <div class="col-lg-6">
            <h4 style="color:#ec971f;">Lista de Tipos de Cierre</h4>
            <hr/>
        </div>
	            ...
	            <?php if (!empty($resultSet)) {  foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <td style="color:#000000;font-size:80%;"> <?php echo $res->nombre_tipo_cierre; ?>     </td> 
			             ...
			             <td>   
			                	<div class="right">
			                    <a href="<?php echo $helper->url("TipoCierre","borrarId"); ?>&id_tipo_cierre=<?php echo $res->id_tipo_cierre; ?>" class="btn btn-danger" onClick="Borrar()"style="font-size:65%;">Borrar</a>
			                </div>
