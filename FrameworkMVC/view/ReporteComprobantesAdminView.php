...
<html lang="es">
	...
	function load_comprobantes(pagina){
		...
		$.ajax({
			url:"<?php echo $helper->url("ComprobantesAdmin","ReporteComprobantes");?>",
            type : "POST",
            async: true,			
			data: con_datos,
		...
		<script>
	       	$(document).ready(function(){ 	
				$( "#numero_ccomprobantes" ).autocomplete({
      				source: "<?php echo $helper->url("ComprobantesAdmin","AutocompleteNComprobantes"); ?>",
      				minLength: 1
    			});
     ...
     <script>
	       	$(document).ready(function(){ 	
				$( "#referencia_doc_ccomprobantes" ).autocomplete({
      				source: "<?php echo $helper->url("ComprobantesAdmin","AutocompleteRComprobantes"); ?>",
      				minLength: 1
    			});
  ...
  <div class="row" style="background-color: #ffffff;">
      ...
      <form action="<?php echo $helper->url("ComprobantesAdmin","ReporteComprobantes"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-12" target="_blank">
