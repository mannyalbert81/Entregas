...
<html lang="es">
      ...
      <head>
        ...
        <meta charset="utf-8"/>
        <title>Tipo de Persona - Contabilidad 2016</title>
  ...
  <div class="row" style="background-color: #FAFAFA;">
      ...
      <form action="<?php echo $helper->url("Tipo_Persona","InsertaPersona"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-6">
            <br>
         
        	     <?php if ($resultEdit !="" ) { foreach($resultEdit as $resEdit) {?>
            
            <div class="well">
            <h4 style="color:#ec971f;">Insertar Tipo de Persona</h4>
  			 <hr/>
       ...
       <form action="<?php echo $helper->url("Tipo_Persona","index"); ?>" method="post" enctype="multipart/form-data"  class="col-lg-6">
     		<br>
     		<div class="well">  
            <h4 style="color:#ec971f;">Tipo de Persona Registrado</h4>
