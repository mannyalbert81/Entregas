...
class Conectar{
    ...
    public function conexion(){
        ...
        $con = pg_connect("host=186.4.203.42 port=5432 dbname=prodimeda user=postgres password=.Romina.2012 ");
    ...
    public function startFluent(){
        ...
        if($this->driver=="pgsql" || $this->driver==null){
        	...
        	try
        	{
            	...
            	$pdo = new PDO('pgsql:host=186.4.203.42;port=5432;dbname=prodimeda', 'postgres', '.Romina.2012' );
