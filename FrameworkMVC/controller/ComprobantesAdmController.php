...
class ComprobantesAdmController extends ControladorBase{
...
//maycol
	...
	public function ReporteComprobantesAdm(){
		...
		if (isset(  $_SESSION['usuario_usuarios']) )
		{
			...
			$nombre_controladores = "ComprobantesAdm";
			...
			if (!empty($resultPer))
			{
				...
				$this->view("ReporteComprobantesAdm",array(
	...
	public function Reporte_ImprimirComprobantesAdm()
	{
