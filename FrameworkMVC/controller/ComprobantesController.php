...
//maycol
   ...
   */
	...
	public function AutocompleteNComprobantes(){
		...
		entidades.id_entidades = ccomprobantes.id_entidades AND ccomprobantes.id_usuarios = usuarios.id_usuarios AND ccomprobantes.id_entidades='$_id_entidades' AND ccomprobantes.id_usuarios ='$_id_usuarios'";
		$id ="ccomprobantes.numero_ccomprobantes";
