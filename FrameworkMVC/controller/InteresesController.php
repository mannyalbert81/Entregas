...
class InteresesController extends ControladorBase{
	...
	public function index(){
		...
		if (isset(  $_SESSION['usuario_usuarios']) )
		{
			...
			{
				$this->view("Error",array(
						"resultado"=>"No tiene Permisos de Acceso a Intereses"
